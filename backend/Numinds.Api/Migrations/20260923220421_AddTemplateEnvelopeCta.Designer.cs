...
namespace Numinds.Api.Migrations
{
    ...
    [Migration("20260923220421_AddTemplateEnvelopeCta")]
    partial class AddTemplateEnvelopeCta
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Numinds.Api.Models.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("EngagementEmailSentAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Numinds.Api.Models.Entities.Invitation", b =>
                {
                    ...
                    b.Property<DateTime?>("TransferTokenExpiresAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Numinds.Api.Models.Entities.PaymentAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Numinds.Api.Models.Entities.Template", b =>
                {
                    ...
                    b.Property<string>("EnvelopeCtaBgColor")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");

                    b.Property<string>("EnvelopeCtaShape")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)");

                    b.Property<string>("EnvelopeCtaTextAr")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");

                    b.Property<string>("EnvelopeCtaTextColor")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");

                    b.Property<string>("EnvelopeCtaTextEn")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");
                    ...
                    b.Property<string>("SceneLayoutStyle")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)");
